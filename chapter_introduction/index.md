...
而深度学习是机器学习的一个主要分之，我们稍后将对其进行更详细的解析。
...
就算一些深度学习模型在小数据集上能够工作，但其效能并不比不上传统方法。
...
一种常见的问题来着不均衡的数据集，比如在一个有关医疗的训练数据集中，某些人群没有样本表示。
...
*深度强化学习*（deep reinforcement learning）将深度学习应用于强化学习的问题，现在很受欢迎。突破性的深度Q网络（Q-network）在雅达利游戏中仅使用视觉输入就击败了人类，以及 AlphaGo 程序在棋盘游戏围棋中击败了世界冠军，是两个突出的例子。
