...
但现实图片会更加复杂，它们可能不仅仅包含一个主体物体。**物体检测**就是针对这类问题提出，它不仅是要分析图片里有什么，而且需要识别它在什么位置。我们使用在以下图片作为样例，并对它标上主要物体和位置。
...
## 扫码直达[讨论区](https://discuss.gluon.ai/t/topic/2510)

![](../img/qr_object-detection.svg)
