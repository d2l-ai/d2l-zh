...
for times in range(10):
    ...
    if first_time:
        ...
        if min_avg_test_loss > average_test_loss:
            ...
            best_hidden_nodes = hidden_nodes
            best_weight_decay = weight_decay
    print('current_best_loss', min_avg_test_loss)    
    print('current_best_learning_rate', best_learning_rate)    
    print('current_best_hidden_nodes', best_hidden_nodes)    
    print('current_best_weight_decay', best_weight_decay)    
print('+'*100)
