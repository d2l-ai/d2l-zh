...
[
 {
  "data": {
   "text/plain": "dict_keys(['glove', 'fasttext'])"
  },
  "execution_count": 2,
  "metadata": {},
...
[
 {
  "name": "stdout",
  "output_type": "stream",
  "text": "['glove.42B.300d.txt', 'glove.6B.50d.txt', 'glove.6B.100d.txt', 'glove.6B.200d.txt', 'glove.6B.300d.txt', 'glove.840B.300d.txt', 'glove.twitter.27B.25d.txt', 'glove.twitter.27B.50d.txt', 'glove.twitter.27B.100d.txt', 'glove.twitter.27B.200d.txt']\n"
 }
]
```
