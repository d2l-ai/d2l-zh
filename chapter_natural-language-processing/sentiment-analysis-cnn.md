...
在早先的章节中我们探究了使用二维卷积神经网络来处理二维图像数据。但文本数据只有一个维度，通常我们将它当做时间维度，从而适合循环神经网络。但我们也可以将文本当做是一维图像，从而可以用一维卷积神经网络来抓取词与临近词之间的关联。本节我们将介绍将卷积神经网络应用到文本数据的开创性工作之一：textCNN [1]。先导入本节需要的包和模块。
