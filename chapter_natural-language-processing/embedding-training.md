...
[
 {
  "name": "stdout",
  "output_type": "stream",
  "text": "closest tokens to \"chip\": operational, triggering, resolved, market-share, bar, paul, iron, exploded, lies, wastewater\n"
 }
]
```
...
[
 {
  "name": "stdout",
  "output_type": "stream",
  "text": "epoch 1, time 3.69s, train loss 0.30\nclosest tokens to \"chip\": intel, chips, silicon, shortage, memory, flaws, microprocessors, microprocessor, graphics, risc\nepoch 2, time 3.62s, train loss 0.25\nclosest tokens to \"chip\": microprocessor, intel, flaws, microprocessors, micro, mips, silicon, desktop, chips, catching\nepoch 3, time 3.59s, train loss 0.21\nclosest tokens to \"chip\": intel, microprocessor, microprocessors, risc, chips, bugs, flaws, motorola, mips, micro\nepoch 4, time 3.63s, train loss 0.20\nclosest tokens to \"chip\": intel, microprocessor, mips, chips, flaws, microprocessors, sessions, vogelstein, circuits, risc\nepoch 5, time 3.55s, train loss 0.19\nclosest tokens to \"chip\": intel, chips, microprocessor, microprocessors, flaws, mips, bugs, desktop, risc, eurodollars\n"
 }
]
```
