...
不稳定梯度带来的风险不止在于数值表示。不稳定梯度也威胁到我们优化算法的稳定性。我们可能面临一些问题。要么参数更新过大，破坏了我们的模型（*梯度爆炸*问题）；要么参数更新过小（*梯度消失*问题），参数在每次更新时几乎不会移动，导致无法学习。
...
:begin_tab:`mxnet`
[Discussions](https://discuss.d2l.ai/t/topic/1819)
:end_tab:

:begin_tab:`pytorch`
[Discussions](https://discuss.d2l.ai/t/topic/1818)
:end_tab:

:begin_tab:`tensorflow`
[Discussions](https://discuss.d2l.ai/t/topic/1817)
:end_tab:
